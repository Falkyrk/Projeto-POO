	...
	public FormCliente() {
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//O Id do usuario recebe apenas numeros inteiros, porem a caixa em que é digitado o ID é do tipo text.
				//Portanto se faz necessario realizar uma conversão de texto para inteiro
